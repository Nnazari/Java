...
public abstract class FractalGenerator {
    ...
    public void Zoom(Rectangle2D.Double range, double centerX, double centerY, double scale) {
    ...
    public void Unzoom(Rectangle2D.Double range, double centerX, double centerY, double scale) {
